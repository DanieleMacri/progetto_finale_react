        ...
        <>
            <footer className="d-flex justify-content-center align-items-center py-3 py-4  footer-custom">
                ...
                <ul className="nav col-md-4 justify-content-center list-unstyled d-flex">
                    <li className="ms-3"><i class="fa-brands fa-github fa-lg text-white"></i></li>
                    <li className="ms-3"><i class="fa-brands fa-facebook fa-lg text-white"></i></li>
                    <li className="ms-3"><i class="fa-brands fa-instagram fa-lg text-white"></i></li>
                </ul>
            </footer>
        </>
    )
